...
model.compile(
    ...
    loss =[categorical_focal_loss(alpha=[[.25, .25, .25]], gamma=2)],#'categorical_crossentropy'
...
print('train      class_dictionary :',class_dictionary)
class_dictionary = validation_generator.class_indices
print('validation class_dictionary :',class_dictionary)
